  ...
  <div>
    ...
    >
      <span
        v-for="(tag, i) in tags"
        :key="tag"
        class="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-prado-signature-muted text-prado-signature text-xs font-medium"
      >
        {{ tag }}
        <button
          type="button"
          class="p-0.5 rounded hover:bg-prado-signature/30 transition-colors"
